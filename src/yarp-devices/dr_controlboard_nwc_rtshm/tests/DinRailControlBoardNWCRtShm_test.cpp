 ...
 *
 * Reuses the dr_controlboard_nwc_yarp interface conformance tests against the
 * real-time shared-memory device pair (dr_controlboard_nwc_rtshm / _nws_rtshm).
 */
...
TEST_CASE("dev::DinRailControlBoardNWCRtShmTest", "[yarp::dev]")
{
    Network::setLocalMode(true);

    SECTION("Checking rtshm controlboard device (using fakeMotionControl)")
    {
        PolyDriver ddmc;
        PolyDriver ddnws;
        PolyDriver ddnwc;
        ...
        {
            Property p_cfg;
            p_cfg.put("device", "dr_controlboard_nws_rtshm");
        ...
        {
            Property p_cfg;
            p_cfg.put("device", "dr_controlboard_nwc_rtshm");
    ...
    SECTION("Checking rtshm controlboard device (using fakeMotionControlMicro)")
    {
        PolyDriver ddmc;
        PolyDriver ddnws;
        PolyDriver ddnwc;
        ...
        }
        {
            Property p_cfg;
            p_cfg.put("device", "dr_controlboard_nws_rtshm");
            p_cfg.put("name", "/controlboardserver_micro");
            REQUIRE(ddnws.open(p_cfg));
        }
...

        {
            Property p_cfg;
            p_cfg.put("device", "dr_controlboard_nwc_rtshm");
            p_cfg.put("local", "/local_controlboard_micro");
            p_cfg.put("remote", "/controlboardserver_micro");
            REQUIRE(ddnwc.open(p_cfg));
        }
