...
* \code{.unparsed}
* yarpdev --device remote_controlboard --remote <mandatory_value> --local <mandatory_value> --namesuffix /dinrail --writeStrict <optional_value> --carrier udp --timeout 0.5 --local_qos::enable false --local_qos::thread_priority 0 --local_qos::thread_policy 0 --local_qos::packet_priority <optional_value> --remote_qos::enable false --remote_qos::thread_priority 0 --remote_qos::thread_policy 0 --remote_qos::packet_priority <optional_value> --ignoreProtocolCheck false --diagnostic false
* \endcode
*
* \code{.unparsed}
...
public:
    ...
    const std::string m_device_name = {"ControlBoardNWCDinRailYARPPorts"};
