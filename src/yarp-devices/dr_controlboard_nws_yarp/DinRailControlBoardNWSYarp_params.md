 ...
 * |   | emulate_impedance_all_setpoints_control | bool | - | false | No | Emulate dinrail IImpedanceAllSetPointsControl if subdevice does not expose it | uses existing YARP interfaces, disabled by default |
