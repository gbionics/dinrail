...
std::string DinRailControlBoardNWCYarp_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc
          + std::string("'timeout': timeout for the input port which receives the streamed robot "
                        "state\n");
    doc = doc + std::string("'local_qos::enable': Enable the usage of local Qos\n");
    doc = doc
          + std::string("'local_qos::thread_priority': Local Qos. See "
                        "https://yarp.it/latest/channelprioritization.html\n");
    doc = doc
          + std::string("'local_qos::thread_policy': Local Qos. See "
                        "https://yarp.it/latest/channelprioritization.html\n");
    doc = doc
          + std::string("'local_qos::packet_priority': Local Qos. See "
                        "https://yarp.it/latest/channelprioritization.html\n");
    doc = doc + std::string("'remote_qos::enable': Enable the usage of remote Qos\n");
    doc = doc
          + std::string("'remote_qos::thread_priority': Remote Qos. See "
                        "https://yarp.it/latest/channelprioritization.html\n");
    doc = doc
          + std::string("'remote_qos::thread_policy': Remote Qos. See "
                        "https://yarp.it/latest/channelprioritization.html.\n");
    doc = doc
          + std::string("'remote_qos::packet_priority': Remote Qos. See "
                        "https://yarp.it/latest/channelprioritization.html.\n");
    ...
    doc = doc
          + std::string("Here are some examples of invocation command with yarpdev, with all "
                        "params:\n");
    doc = doc
          + " yarpdev --device remote_controlboard --remote <mandatory_value> --local "
            "<mandatory_value> --namesuffix /dinrail --writeStrict <optional_value> --carrier udp "
            "--timeout 0.5 --local_qos::enable false --local_qos::thread_priority 0 "
            "--local_qos::thread_policy 0 --local_qos::packet_priority <optional_value> "
            "--remote_qos::enable false --remote_qos::thread_priority 0 "
            "--remote_qos::thread_policy 0 --remote_qos::packet_priority <optional_value> "
            "--ignoreProtocolCheck false --diagnostic false\n";
