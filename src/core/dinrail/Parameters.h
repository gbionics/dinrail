...
public:
    ...
    bool getParameter(const std::string& key, GenericVector<double>::Ref parameter) const;
    /** @brief BLF-style getter for string vectors. */
    bool getParameter(const std::string& key, GenericVector<std::string>::Ref parameter) const;
