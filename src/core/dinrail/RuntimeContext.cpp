...
std::vector<RuntimeContext::InteropDevices> RuntimeContext::listInteropDevices() const
{
    return getAvailableInteropDevices();
}

std::vector<RuntimeContext::DeviceInfo> RuntimeContext::listNativeDevices() const
{
    return getAvailableNativeDevices();
}

std::vector<RuntimeContext::InteropPluginInfo> RuntimeContext::listInteropPlugins() const
{
    return getAvailableInteropPlugins();
}

RuntimeContext::AvailableDevices RuntimeContext::listDevices() const
{
