 ...
 * element is \a iterable (i.e. the element has the methods
 ...
 * element is \a iterable (i.e. the element has the methods
 * <code>T::begin()<\code> and <code>T::end()<\code>). This specific
 * implementation is used when the the object is iterable, indeed
 ...
 * check if an element has <em>square bracket operator</em> (i.e. operator[]()).
 ...
 * has_square_bracket_operator is used to build a type-dependent expression that
 * check if an element has <em>square bracket operator</em> (i.e. operator[]()).
 * This specific implementation is used when the the object has the square
 * bracket operator, indeed <code>void_t<\code> is used to detect ill-formed
 ...
 * element is \a resizable (i.e. the element has the methods
 ...
 * element is \a resizable (i.e. the element has the methods
 * <code>T::resize()<\code>). This specific implementation is used when the the
 * object is not \a resizable. Indeed <code>void_t<\code> is used to detect
...
/**
 * is_size_available is a utility metafunction to detect if typename T contains
 * the <code>size()<\code> method. This specialization uses <code>void_t<\code>
...
/**
 * is_data_available is a utility metafunction to detect if typename T contains
 * the <code>data()<\code> method. This specialization uses <code>void_t<\code>
 * to detect ill-formed types in SFINAE context.
 */
template <typename T>
...
/**
 * has_type_member is a utility metafunction to detect if typename T defines
 * <code>value_type<\code>, i.e. <code>T::value_type<\code> is available. This
...
/**
 * container_data is a utility metafunction to detect the type of container.
 * This specialization is enabled if <code>T::value_type<\code> is not
 * available, but the method <code>data()<\code> is.
 */
template <typename T>
struct container_data<
...
/**
 * size_type is a utility metafunction to detect the type used for the indices
 * in the container. In this specialization it returns the return type of the
...
/**
 * is_string is a utility metafunction to detect the if a given type is a
 ...
 * the class Ref. This specific implementation is called if Test is not
...
/**
 * is_specialization is used to check if the type Test is a specialization of
 * the class Ref. This specific implementation is called if Test is specialized
 * from Ref.
 */
