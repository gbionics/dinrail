 ...
 *
 * @p Source must be a polymorphic class (i.e. a class that inherits from at least a virtual method).
 *
 * @code{.cpp}
 ...
 *
 * @param source Non-owning view of the exact static source subobject, created by `dinrail::makePolymorphicView`.
