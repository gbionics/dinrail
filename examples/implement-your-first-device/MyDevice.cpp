...
// Register this class as a dinrail device plugin.
// The first argument is the factory symbol name, which must follow the pattern
// "dinrail_device_<devicename>" (hyphens replaced with underscores).
SHLIBPP_DEFINE_SHARED_SUBCLASS(dinrail_device_myDevice, MyDevice, dinrail::IDevice)
